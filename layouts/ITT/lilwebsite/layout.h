...
const struct keystate stop_key = {0, 51, 0};
const struct keystate play_pause = {0, 61, 0};
const struct keystate next_track = {0, 73, 0};
const struct keystate prev_track = {0, 84, 0};
const struct keystate redo_key = {0, 94, 0};
const struct keystate undo_key = {0, 95, 0};
const struct keystate paste_key = {0, 106, 0};
const struct keystate copy_key = {0, 117, 0};
const struct keystate cut_key = {0, 128, 0};
...
const uint8_t keymap[COLUMNS] = {
	...
	KEY_2,		KEY_F4,		KEY_F1,		0,			BACKSPACE,	0,			LBRACE,		KEY_9,		KEY_8,		KEY_7,		KEY_5,		KEY_3,
	...
	0,			KEY_HOME,	KEY_UP,		KEY_SLASH,	KEY_L,		KEY_J,		KEY_G,		0,			KEY_D,		KEY_A,		0,			0,		
