...
const uint8_t keymap[COLUMNS] = {
	0,			KEYPAD_ENT,	KEYPAD_PLS,	KEYPAD_AST,	KEYPAD_SLH,	NUMLOCK,	KEYPAD_7,	KEYPAD_1,	KEYPAD_4,	KEYPAD_0,	KEYPAD_MIN,	KEYPAD_PRD,
	...
	KEY_2,		KEY_F4,		KEY_F1,		KEY_F13,	BACKSPACE,	KEY_F13,	LBRACE,		KEY_9,		KEY_8,		KEY_7,		KEY_5,		KEY_3,
	KEY_1,		KEY_F14,	0,			BACKSLASH,	KEY_ENTER,	KEY_P,		KEY_O,		KEY_U,		0,			KEY_T,		KEY_E,		KEY_Q,
	KEY_TILDE,	KEY_F15,	PAGE_UP,	RSHIFT,		KEY_QUOTE,	KEY_SEMI,	KEY_I,		KEY_Y,		KEY_R,		KEY_W,		0,			KEY_TAB,
	KEY_F16,	KEY_HOME,	KEY_UP,		KEY_SLASH,	KEY_L,		KEY_J,		KEY_G,		0,			KEY_D,		KEY_A,		LEFT_GUI,	KEY_F17,
	DEL,		PAGE_DOWN,	RIGHT_ALT,	KEY_PERIOD,	KEY_K,		KEY_H,		KEY_F,		KEY_S,		KEY_Z,		LCTRL,		KEY_F18,	KEY_END,
	KEY_DOWN,	KEY_LEFT,	0,			KEY_COMMA,	KEY_N,		KEY_V,		KEY_X,		LEFT_ALT,	LSHIFT,		KEY_F19,	KEY_INSERT,	KEY_RIGHT,
