...
const struct kblayer PROGMEM kblayer_list[LAYERS] = {
	{
		...
		MATRIX_POS(
			...
			//0          1          2          3          4          5          6          7<-col        row
			             ...
			             KEY_4,     KEY_R,     KEY_F,     KEY_C,                L_CTRL,            //2  {4, r, f, c, NC, ctrl-l}
			             KEY_5,     KEY_T,     KEY_G,     KEY_V,     L_SHIFT,   KEY_A,             //3  {5, t, g, v, shift-l, a}
			             KEY_6,     KEY_Y,     KEY_H,     KEY_B,     L_GUI,     0,                 //4  {6, y, h, b, host-l, reset(special)}
			             KEY_7,     KEY_U,     KEY_J,     KEY_N,                L_ALT,             //5  {7, u, j, n, NC, alt-l}
			             KEY_8,     KEY_I,     KEY_K,     KEY_M,     KEY_SPACE, 0,                 //6  {8, i, k, m, space, numpad 00(special)}
			             KEY_9,     KEY_O,     KEY_L,     COMMA,     R_GUI,     R_ALT,             //7  {9, o, l, ,, host-r, alt-r}
			             KEY_0,     KEY_P,     KEY_SEMI,  PERIOD,    KEY_0,     ENTER,             //8  {0, p, ;, ., numpad 0, enter}
			             KEY_EQUAL, KEY_HYPHEN, KEY_QUOTE, KEY_SLASH, PAGE_UP,   PERIOD,            //9  {=, @, :, /, pgUP, numpad .}
			             KEY_TILDE, L_BRACE,    R_BRACE,    PRTSCN,    PAGE_DOWN, 0,                 //10 {~, [, ], printscreen, pgDN, E16}
			             NUMLOCK,   BACKSLASH, R_CTRL,    R_SHIFT,   KEY_F11,   0,                 //11 {numlock, \, control-r, shift-r, F11, E15}
...

	{
		...
		MATRIX_POS(
			...
			//0            1            2            3            4            5            6            7<-col    row
			                        ...
			                        KEY_4,        KEY_R,        KEY_F,        KEY_C,                    L_CTRL,        //2
			                        KEY_5,        KEY_T,        KEY_G,        KEY_V,        L_SHIFT,        KEY_A,        //3
			                        KEY_6,        KEY_Y,        KEY_H,        KEY_B,        0,            CAPS,        //4
			                        KEY_7,        KEY_U,        KEY_J,        KEY_N,                    L_ALT,    //5
			                        KEY_8,        KEY_I,        KEY_K,        KEY_M,        KEY_SPACE,    0,            //6
			                        KEY_9,        KEY_O,        KEY_L,        COMMA,        0,            R_ALT,    //7
			                        KEY_0,        KEY_P,        KEY_SEMI,    PERIOD,        KEYPAD_0,    ENTER,        //8
			                        KEY_EQUAL,    KEY_HYPHEN,    KEY_QUOTE,    KEY_SLASH,    PAGE_UP,    KP_PRD,    //9
			                        KEY_TILDE,    L_BRACE,        R_BRACE,        PRTSCN,        PAGE_DOWN,    0,            //10
			                        NUMLOCK,    BACKSLASH,    R_CTRL,        R_SHIFT,        KEY_F11,    0,            //11
